// dsh-composer-keys — shared constants and pure helpers.
//
// Deliberately free of `schemastery` (and of every other dependency): the settings
// schema lives in ./index.js, while this module is what the repo's unit tests
// import — the GUI checkout has no schemastery, so keeping the pure logic here is
// what lets `npm test` cover it without adding a dependency to the shell.
